...
pop1 = nest.Create("izhikevich",1,{'V_m':-70.0,'I_e':18.0,'a':0.005,'b':0.2,'c':-65.0,'d':6.0})
...
def createSyn(inputLayer, outputLayer, fireRateRatio):
	syn_dict_ex = {"weight": 1.2}
	syn_dict_in = {"weight": -2.0}
	nest.Connect(inputLayer, outputLayer, syn_spec=syn_dict_ex)
	nest.Connect(inputLayer, outputLayer, syn_spec=syn_dict_in)
